...
{
    class WindowResponsi : GameWindow
    {
        private Mesh mesh0;
        private Mesh mesh1;
        private Mesh mesh2;
        ...
        public WindowResponsi(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings) : base(gameWindowSettings, nativeWindowSettings)
        {
        }
        ...
        protected override void OnLoad()
        {
            ...
            mesh0 = LoadObjFile("../../Resources/MeteorInverted.obj");
            mesh0.setupObject(1.0f, 1.0f);
            mesh0.scale(5f);


            mesh1 = LoadObjFile("../../Resources/meguminfinal.obj");
            mesh1.setupObject(1.0f, 1.0f);
            mesh1.translate(new Vector3(0f, 0f, 0f));
            mesh1.scale(2f);

            mesh2 = LoadObjFile("../../Resources/Castle3.obj");
            ...
            mesh5 = LoadObjFile("../../Resources/Chomusuke.obj");
            mesh5.setupObject(1.0f, 1.0f);
            mesh5.scale(0.2f);
            mesh5.rotate(0f, 180f, 0f);
            mesh5.translate(new Vector3(0f, 0f, 3f));
